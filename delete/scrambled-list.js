...
var $exeScrambledList = {
	...
	getLinksHTML : function(i,listOrder){
		return '<span> <a href="#" class="up exe-sortableList-sorter exe-sortableList-sort-'+i+'_'+(i-1)+'_'+listOrder+'" title="'+(i+1)+' &rarr; '+i+'"><span class="sr-av ocultar">'+(i+1)+' &rarr; '+i+'</span></a> <a href="#" class="down exe-sortableList-sorter exe-sortableList-sort-'+i+'_'+(i+1)+'_'+listOrder+'" title="'+(i+1)+' &rarr; '+(i+2)+'"><span class="sr-av ocultar">'+(i+1)+' &rarr; '+(i+2)+'</span></a></span>';
	},
